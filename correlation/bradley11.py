...
def corrB11(T, duration='Ds575'):
    ...
    if duration == 'Ds575':  # default
        if 0.01 <= T < 0.09:
            rho = -0.45 + (np.log(T / 0.01) /
                           np.log(0.09 / 0.01)) * (-0.39 + 0.45)
        elif 0.09 <= T < 0.3:
            rho = -0.39 + (np.log(T / 0.09) /
                           np.log(0.30 / 0.09)) * (-0.39 + 0.39)
        elif 0.3 <= T < 1.4:
            rho = -0.39 + (np.log(T / 0.30) /
                           np.log(1.4 / 0.3)) * (-0.06 + 0.39)
        elif 1.4 <= T < 6.5:
        ...
        if 0.01 <= T < 0.04:
            rho = -0.41 + (np.log(T / 0.01) /
                           np.log(0.04 / 0.01)) * (-0.41 + 0.41)
        elif 0.04 <= T < 0.08:
            rho = -0.41 + (np.log(T / 0.04) /
                           np.log(0.08 / 0.04)) * (-0.38 + 0.41)
        elif 0.08 <= T < 0.26:
            rho = -0.38 + (np.log(T / 0.08) /
                           np.log(0.26 / 0.08)) * (-0.35 + 0.38)
        elif 0.26 <= T < 1.4:
            rho = -0.35 + (np.log(T / 0.26) /
                           np.log(1.4 / 0.26)) * (-0.02 + 0.35)
        elif 1.4 <= T < 6.00:
            rho = -0.02 + (np.log(T / 1.4) /
                           np.log(6.00 / 1.4)) * (0.23 + 0.02)
        else:
            rho = 0.23 + (np.log(T / 6.00) /
                          np.log(10.00 / 6.00)) * (0.02 - 0.23)
        return rho
